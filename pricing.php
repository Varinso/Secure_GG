...
<head>
    ...
    -->
	<link rel="apple-touch-icon" sizes="180x180" href="./assets/logo/LOGO.jpg">
	<link rel="icon" type="image/jpg" sizes="32x32" href="./assets/logo/LOGO.jpg">
	<link rel="icon" type="image/jpg" sizes="16x16" href="./assets/logo/LOGO.jpg">
...
<body>
		...
		<div class="row align-items-center align-items-xl-stretch flex-column flex-xl-row">
			<div class="col-12 col-sm-10 col-md-7 col-lg-6 col-xl-4 mt-5">
				<div class="p-5 h-100 d-flex flex-column bg-body-tertiary shadow rounded-4">
					...
					<p class="lead">
						rent console games for affortable price.
					</p>

					<div class="mt-auto">
						<a href="rental.php" class="btn btn-primary text-white mt-4 w-100">
							RENT!!
						</a>
					</div>
				</div>
			...
			<div class="col-12 col-sm-10 col-md-7 col-lg-6 col-xl-4 mt-5 position-relative">
				<div class="p-5 h-100 d-flex flex-column bg-body-tertiary shadow rounded-4">
					<span class="badge position-absolute translate-middle top-0 start-75 text-bg-success px-3 py-2 rounded-4"></span>
					<h2>Book Booth</h2>

					<p class="lead">
						Book booth to enjoy gaming with your friends.
					</p>

					<div class="mt-auto">
						<a href="booth.php" class="btn btn-primary text-white mt-4 w-100">
							BOOK NOW!!
						</a>
					</div>
				</div>
			...
			<div class="col-12 col-sm-10 col-md-7 col-lg-6 col-xl-4 mt-5">
				<div class="p-5 h-100 d-flex flex-column bg-body-tertiary shadow rounded-4">
					...
					<p class="lead">
						Enroll in tournament and show your gaming skills.
					</p>

					<div class="mt-auto">
						<a href="tournament.php" class="btn btn-primary text-white mt-4 w-100">
							ENROLL
						</a>
					</div>
				</div>
	...
	<div class="d-flex justify-content-between align-items-center flex-wrap">
		<div class="order-last order-md-first mt-5 text-body-secondary leading-6 text-sm">
			...
			Gamers Galaxy, All rights reserved.
		</div>
