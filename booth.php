		    ...
		    <div class="container h-100 d-flex align-items-center">
                <div class="max-w-2xl mx-auto text-center">
                    ...
                    <p class="m-0 mt-4 text-white text-lg leading-8" data-aos-delay="100" data-aos="fade" data-aos-duration="3000">
                        Book a booth for your event and enjoy the best gaming experience.
                    </p>
                </div>
		    </div>
	    </div>
...
if (!$result) {
    die("Error fetching booths: " . mysqli_error($conn));
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Available Booths for Booking</title>
...
<body>
    ...
    <main class="container my-5">
        <h1 class="text-center mb-4">Available Booths for Booking</h1>
            ...
            <div class="row">
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo htmlspecialchars($row['booth_name']); ?></h5>
                                <p class="card-text"><strong>Location:</strong> <?php echo htmlspecialchars($row['location']); ?></p>
                                <p class="card-text"><strong>Capacity:</strong> <?php echo htmlspecialchars($row['capacity']); ?> people</p>
                                <p class="card-text"><strong>Price:</strong> Tk<?php echo htmlspecialchars($row['prices']); ?></p>
                                
                                <?php if ($row['capacity'] > 0) { ?>
                                    <form action="booth_booking.php" method="GET">
                                        <input type="hidden" name="booth_id" value="<?php echo htmlspecialchars($row['booth_id']); ?>">
        ...
        <?php } else { ?>
            <p class="text-center">No booths available at the moment.</p>
        <?php } ?>
    </main>
