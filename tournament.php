		...
		<div class="container h-100 d-flex align-items-center">
			<div class="max-w-2xl mx-auto text-center">
				...
				<p class="m-0 mt-4 text-white text-lg leading-8" data-aos-delay="100" data-aos="fade" data-aos-duration="3000">
					Participate in our upcoming tournaments and win exciting prizes.
				</p>
			</div>
		</div>
	</div>
...
if (!$result) {
	die("Error fetching tournaments: " . mysqli_error($conn));
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
	...
	<main class="container my-5">
		<h1 class="text-center mb-4">Upcoming Tournaments</h1>
					...
					<div class="col-md-4 mb-4">
						<div class="card">
							<div class="card-body">
								...
								<p class="card-text"><strong>Game:</strong> <?php echo htmlspecialchars($row['game_title']); ?></p>
								<p class="card-text"><strong>Start Date:</strong> <?php echo htmlspecialchars($row['start_date']); ?></p>
								<p class="card-text"><strong>End Date:</strong> <?php echo htmlspecialchars($row['end_date']); ?></p>
								<p class="card-text"><strong>Prize Pool:</strong> Tk<?php echo htmlspecialchars($row['prize_pool']); ?></p>
								...
								<form action="tournament_enroll.php" method="GET">
									...
									<button type="submit" class="btn btn-primary w-100" <?php echo $row['status'] === 'closed' ? 'disabled' : ''; ?>>
										Enroll Now
									</button>
								</form>
							</div>
